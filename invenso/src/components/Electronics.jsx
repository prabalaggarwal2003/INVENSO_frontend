...
//     issueHistory: "String",
//     condition: "New",
//     qrCode: `bpitindia.invenso.com/${equipmentType}/${equipmentId}`,
//     isActive: false
//   });
...
//     axios.post('http://localhost:3000/assetManagement/equipment', updatedFormData)
//       .then(response => {
...
//             Equipment ID:
//             <input type="number" name="equipmentId" value={formData.equipmentId} onChange={handleChange} className="form-input" required />
//           </label>
//           <br />
//           <label className="form-label">
//             Equipment Type:
